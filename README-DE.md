...
services:
  pigeon-pod:
    ...
    image: 'ghcr.io/aizhimou/pigeon-pod:release-${version}' # ersetzen Sie ${version} mit der neuesten Versionsnummer, z.B. 1.0.0.
...
- [So erhalten Sie einen YouTube-API-Schlüssel](documents/how-to-get-youtube-api-key-en.md)
- [So richten Sie YouTube-Cookies ein](documents/youtube-cookie-setup-en.md)
- [So erhalten Sie eine YouTube-Kanal-ID](documents/how-to-get-youtube-channel-id-en.md)
