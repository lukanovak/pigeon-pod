...
services:
  pigeon-pod:
    ...
    image: 'ghcr.io/aizhimou/pigeon-pod:release-${version}' # substitua ${version} pelo número da versão mais recente, ex. 1.0.0.
...
- [Como obter a chave da API do YouTube](documents/how-to-get-youtube-api-key-en.md)
- [Como configurar cookies do YouTube](documents/youtube-cookie-setup-en.md)
- [Como obter o ID do canal do YouTube](documents/how-to-get-youtube-channel-id-en.md)
